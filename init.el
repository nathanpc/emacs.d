...
(custom-set-variables
 ...
 '(package-selected-packages
   '(company git-gutter-fringe highlight-indent-guides rainbow-delimiters rainbow-mode highlight-numbers highlight-escape-sequences dimmer doom-modeline nord-theme all-the-icons use-package)))
(custom-set-faces
